  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      const addProduct = async () => {
        ...
        try {
          await contract.postProduct(...Object.values(Product));
        } catch (error) {
          console.error(error);
  ...
  return (
    <>
      <form className="product-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label htmlFor="price">Price (Gwei.)</label>
          <input
            type="number"
            id="price"
            name="price"
        ...
        <div className="form-group">
          ...
          <select id="product-category" className="dropdown" onChange={(e) => handleSelect(e)} value={Product.category}>
